...
#define EFI_ACPI_6_4_GENERIC_INITIATOR_AFFINITY_STRUCTURE_ARCHITECTURAL_TRANSACTIONS (1 << 1)
...
//EFI_ACPI_6_4_PMTT_COMMON_MEMORY_DEVICE  MemoryAggregatorDeviceStructure[NumberOfMemoryDevices];
...
///
/// Firmware Version Data Record Structure
///
typedef struct {
  GUID    ComponentId;
  UINT64  VersionValue;
...
///
#define EFI_ACPI_6_4_PLATFORM_HEALTH_ASSESSMENT_TABLE_SIGNATURE SIGNATURE('P', 'H', 'A', 'T')
